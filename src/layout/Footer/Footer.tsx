...
export function Footer() {
  return (
    ...
    //       </li>
    //       <li>
    //       <p classNameName="text-[#495371] font-bold">QuickfundDao</p>
    //       </li>
    //     </ul>
    //     <ul classNameName="flex items-center space-x-12">
    //       {footerLink.map((item, idx) => {
    //         return (
    //           <li classNameName="text-[#495371]" key={item.name}>
    ...
    <div className="sm:flex sm:items-center sm:justify-between">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://flowbite.com/" className="hover:underline">Quickfund DAO</a>. All Rights Reserved.
        </span>
